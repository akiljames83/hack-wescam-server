...
public class ClassifierActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  */
  ...
  private static final String MODEL_FILE2 = "file:///android_asset/graph2.pb";
  private static final String LABEL_FILE2 = "file:///android_asset/labels2.txt";
  ...
  public void onSetDebug(boolean debug) {
    ...
    classifier2.enableStatLogging(debug);
  }
  ...
  private void renderDebug(final Canvas canvas) {
    ...
    if (copy != null) {
      ...
      if (classifier2 != null) {
        String statString = classifier2.getStatString();
        String[] statLines = statString.split("\n");
        for (String line : statLines) {
          lines.add(line);
        }
